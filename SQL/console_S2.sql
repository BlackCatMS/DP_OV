...
UPDATE medewerkers SET maandsal = (maandsal * 1.055) WHERE functie = 'VERKOPER';
UPDATE medewerkers SET maandsal = (maandsal * 1.07) WHERE mnr = 7698;
...
-- Alders kan niet verwijderd worden, omdat het een foreign key violatet, hen is namelijk nog steeds ingeschreven
-- bij een cursus, en kan dus niet verwijderd worden omdat dat een probleem in de tabel "inschrijvingen zou ver-
-- oorzaken
...
VALUES (50, 'FINANCIEN', 'LEERDAM', 7839)
ON CONFLICT DO NOTHING;                                                                                         -- [TEST]
