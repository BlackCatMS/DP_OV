...
ALTER TABLE medewerkers ADD CONSTRAINT m_geslacht_chk CHECK (geslacht = 'M' OR geslacht = 'V');
...
CREATE SEQUENCE AfdelingVerbetering_seq
START WITH 50
INCREMENT BY 10
CACHE 1;

ALTER TABLE afdelingen ALTER COLUMN anr SET DEFAULT nextval('AfdelingVerbetering_seq');

INSERT INTO afdelingen (anr, naam, locatie, hoofd)
VALUES (DEFAULT, 'VERKOOPLOCATIE', 'BREDA', 7902);
INSERT INTO afdelingen (anr, naam, locatie, hoofd)
VALUES (DEFAULT, 'POP-UP STORE', 'DOETINCHEM', 7902);
